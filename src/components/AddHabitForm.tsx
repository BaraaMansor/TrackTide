          ...
          <div className="flex gap-3 pt-4">
            <div className="relative group flex-1">
              ...
              <button
                type="button"
                onClick={onCancel}
                className="relative cursor-pointer w-full px-6 py-3 bg-white/5 backdrop-blur-md border border-white/20 text-slate-300 rounded-xl hover:bg-white/10 hover:border-white/30 hover:text-white transition-all duration-300 font-medium"
              >
                Cancel
              </button>
            </div>
            <div className="relative group flex-1">
              ...
              <button
                type="submit"
                className="relative w-full cursor-pointer px-6 py-3 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-xl hover:bg-white/15 hover:border-blue-400/40 transition-all duration-300 font-medium shadow-xl hover:shadow-blue-500/20"
              >
                Add Habit
              </button>
            </div>
